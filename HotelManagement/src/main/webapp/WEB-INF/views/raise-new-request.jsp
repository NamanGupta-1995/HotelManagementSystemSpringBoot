...
<body>
	...
	<div style="text-align: center;">
		<h3>PLEASE RAISE A REQUEST FOR CUSTOMER USING THIS PORTAL</h3>

		<div style="text-align: center; height: 600px">
			<form action="addRequest.htm" method="post">
				<h3>Create a new request here.</h3>
				<div>
					<label>Please select the room number : </label>
				...
				<div>
					<label>Please select the request type : </label>
					<select name="requestDD">
				...
				<div>
					...
					<input type="time" style="color: #333;" class="scoreUpdate"
						name="requestTime" required>
