...
<body>
	...
	<div style="text-align: center;">
		<h3>PLEASE ENTER THE DETAILS OF CUTOMER TO CREATE THE BOOKING</h3>

		<div style="text-align: center; height: 800px">
			<form enctype="multipart/form-data" action="addBooking.htm" method="post">
				<h3>Create a booking here.</h3>
				<div>
					<label>Customer Name : </label> 
					<input type="text"
						style="color: #333;" class="scoreUpdate" name="customerFirstName"
						placeholder="Customer First Name" required />
						 <input
						type="text" style="color: #333;" class="scoreUpdate"
						name="customerLastName" placeholder="Customer Last Name" required />
				</div>
				<div>
					<label>Customer Gender : </label> <input type="radio"
						style="color: #333;" class="scoreUpdate" name="customerGender" value="male"> <label>Male</label>
					<input type="radio" style="color: #333;" class="scoreUpdate"
						name="customerGender" value="female"> <label>Female</label>
				</div>
				<div>
					<label>Customer Email : </label> <input type="email"
						style="color: #333;" class="scoreUpdate" name="customerEmail"
						placeholder="Customer Email" required></input>

				</div>
				<div>
					<label>Customer Contact Number : </label> <input type=text
						style="color: #333;" class="scoreUpdate" name="customerContact"
						placeholder="Customer Contact" required></input>
				</div>
				<div>
					<label>Customer Address : </label> <input type="text"
						style="color: #333;" class="scoreUpdate" name="customerAddress"
						placeholder="Customer Address" required></input>
				</div>
				<div>
					<label>Room Number : </label> <input type="text"
						style="color: #333;" class="scoreUpdate" name="roomNumber"
						placeholder="Room Number" required></input>
				</div>
				<div>
					<label>Check-In Date : </label> <input type="date"
						style="color: #333;" class="scoreUpdate" name="checkinDate"
						required></input>
				</div>
				<div>
					<label>Check-Out Date : </label> <input type="date"
						style="color: #333;" class="scoreUpdate" name="checkoutDate"
						required></input>
				</div>
				
				<div>
					<label>Upload Customer ID : </label>
					<input type="file" style="color: #333;" class="scoreUpdate" name="imageFile" required/>
				</div>
	...
	<form action="receptionist.htm" method="get">
		<h4>
			<input
