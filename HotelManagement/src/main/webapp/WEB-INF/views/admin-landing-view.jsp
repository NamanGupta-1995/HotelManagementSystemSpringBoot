...
<nav id="main-menu">
	...
	<div style="text-align: center;">
		...
		<form method="get" action="adminportal.htm">
			<h4>
				<h3>PLEASE TELL US HOW WE DID AND WHERE CAN WE IMPROVE</h3>
				<input
					style="background-color: inherit; border: bold; font-size: 18px;"
					type="submit" value="Admin" name="choice" value="ADD ADMIN">
								<input
					style="background-color: inherit; border: bold; font-size: 18px;"
					type="submit" value="Receptionist" name="choice" value="ADD RECEPTIONIST">
									<input
					style="background-color: inherit; border: bold; font-size: 18px;"
					type="submit" value="Manager" name="choice" value="ADD MANAGER">
			</h4>
		</form>
