...
<div style="text-align: right">
		<form action="updateCust.htm" method="post">
			<input
				style="background-color: inherit; border: bold; font-size: 18px;"
				type="submit" value="UPDATE PROFILE">
		</form>
		<form action="logout.htm" method="get">
	<input style="background-color: inherit; border: bold; font-size: 18px; width: 163px" type="submit" value="LOG OUT">
	</form>
</div>
	...
	<div style="text-align: center;">
		...
		<form action="feedback.htm" method="post">
			<h4>
				<h3>PLEASE TELL US HOW WE DID AND WHERE CAN WE IMPROVE</h3>
				<input
					style="background-color: inherit; border: bold; font-size: 18px;"
					type="submit" value="SUBMIT YOUR FEEDBACK">
			</h4>
		</form>
		<div style="text-align: center;">
				...
				<tbody>
					<c:forEach items="${currentBookings}" var="booking">
						<tr>
							...
							<td data-th="Check-Out Date"><c:out
									value="${booking.getCheckoutDate()}" /></td>
