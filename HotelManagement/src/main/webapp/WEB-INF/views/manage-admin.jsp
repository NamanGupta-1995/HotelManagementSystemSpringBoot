...
<body>
		...
		<table class="rwd-table" width="70%" align='center'>
			...
			<tbody>
				<c:forEach items="${adminList}" var="admins">
					<tr>
						<td data-th="Admin ID"><c:out value="${admins.getId()}" /></td>
						<td data-th="Admin Name"><c:out value="${admins.getName()}" />
						</td>
						<td data-th="Admin Contact"><c:out
								value="${admins.getContact()}" /></td>
						<td data-th="Admin Email"><c:out value="${admins.getEmail()}" />
						</td>
						<td data-th="Admin Role"><c:out value="${admins.getRole()}" />
						</td>
					</tr>
				</c:forEach>
			</tbody>
	...
	<div style="text-align: center;">
		<h3>PLEASE MANAGE ADMINS.</h3>
		<div style="height: 400px">
			<form action="addAdmin.htm" method="post">
				<h3>Create a new ADMIN here.</h3>
				<div>
					<label>Name : </label>
					<input type="text" name="newAdminName" placeholder="Name" required/>
				</div>
				<div>
					<label>Contact : </label>
					<input type="text" name="newAdminContact" placeholder="Contact" required/>
				</div>
				<div>
					<label>Email : </label>
					<input type="text" name="newAdminEmail" placeholder="Email" required/>
				</div>
				<div>
					<label>Password : </label>
					<input type="text" name="newAdminPassword" placeholder="Password" required/>
				</div>
